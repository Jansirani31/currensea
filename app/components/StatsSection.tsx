...
">
    ...
    <p className="mt-12 text-xs sm:text-sm text-[#0CA2FF] leading-6 w-[160px] sm:w-[200px] lg:w-[220px]">
  ...
  <div className="mt-6">
    ...
    ">
      <p>
        Globally trusted liquidity execution
      </p>
      ...
      />
        ...
        ">
          ...
          />
            ...
            <p className="text-xs md:text-sm text-[#FF9CAA] mb-3">
          ...
          <div>
            <h2 className=" text-7xl font-Space font-bold md:text-6xl text-[#FF9CAA]">
              1200+
            </h2>

            <p className="text-xs md:text-sm text-[#FF9CAA] mt-3">
              OTC Trades Executed
            </p>
            <span></span>
          </div>
  ...
  />
        ...
        */}  
         ...
         <div
          ...
          <p className="text-sm text-[#74C8FC] font-medium">
          Backed by
          </p>
         <Image
    ...
    <h2 className="text-4xl md:text-5xl lg:text-6xl font-space font-medium text-[#74C8FC] leading-tight">
      Fintech & crypto
    </h2>

    <p className="text-sm text-[#74C8FC] mt-4">
      product builders
    </p>
  </div>
</div>
        ...
        ">
          <div>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-space font-semibold text-[#FF9CAA]">
              Multi-liquidity
            </h2>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-space font-semibold text-[#FF9CAA]">
              source aggregation
